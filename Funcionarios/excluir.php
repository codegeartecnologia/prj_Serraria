					...
					<div class="tab-content">
				        <div class="tab-pane fade in active" id="dados_pessoais">
							...
							<li> 
								...
								<input type="text" size="12" id="rg" name="rd" value="<?php echo $_POST['rg'] ?>" /> 
							</li>
							<li> 
								<label for="cpf"> CPF: </label>
								<input type="text" size="14" id="cpf" name="cpf" value="<?php echo $_POST['cpf'] ?>" /> 
							</li>
							<li> 
								<label for="data_nasc"> Nascimeto: </label>
								<input type="text" size="12" id="data_nasc" name="data_nasc" value="<?php echo $_POST['data_nasc'] ?>" /> 
							</li>
				        </div> <!-- dados_pessoais -->
				        <div class="tab-pane fade" id="dados_familiar">
				           ...
				           <li> 
								...
								<input type="text" size="40" autofocus="autofocus" name="login" value="<?php echo $_POST['nome_pai'] ?>" /> 
							</li>
							<li> 
								<label for="nome_mae"> Mãe: </label>
								<input type="text" size="40" name="nome_mae" value="<?php echo $_POST['nome_mae'] ?>" /> 
							</li>
							<li id="img">
				        ...
				        <div class="tab-pane fade" id="dados_profissionais">
				            <li> 
								...
								<input type="text" size="15" name="num_carteira" autofocus="autofocus" value="<?php echo $_POST['num_carteira'] ?>" /> 
							</li>
							<li> 
								<label for="pis"> P.I.S: </label>
								<input type="text" size="15" id="pis" name="pis" value="<?php echo $_POST['pis'] ?>" /> 
							</li>
							<li id="img">
							...
							<li id="cnh" style="visibility:hidden;"> 
								...
								<input type="text" size="15" name="cnh" value="<?php echo $_POST['cnh'] ?>" /> 
							</li>
				        ...
				        <div class="tab-pane fade" id="dados_empresariais">
				           <!-- <li> 
								...
								<input type="text" size="50" id="matricula" name="matricula" autofocus="autofocus" value="<?php echo $_POST['matricula'] ?>" /> 
							</li> -->
							<div class="admissao_demissao">
								<li class="li_left">
									<label for="admissao" > Admissão: </label>
									<input type="text" size="12" id="admissao" name="admissao" value="<?php echo $_POST['admissao'] ?>" />
								</li>
								<li class="li_right">
									<label for="demissao" > Demissão: </label>
									<input type="text" size="12" id="demissao" disabled="disabled" name="demissao" value="<?php echo $_POST['demissao'] ?>" />
								</li>	
							</div>						
							<li> 
								<label for="setor"> Setor: </label>
								<input type="text" size="20" name="setor" value="<?php echo $_POST['setor'] ?>" /> 
							</li>
							<li> 
								<label for="salario"> Salário: </label>
								<input type="text" size="10" name="salario" value="<?php echo  $_POST['salario'] ?>" onKeyUp="moeda(this);" /> 
							</li>
							<li class="center">
