<?php
	...
	function inicializa(){
		...
		//constantes
		$constantes = array('BASEPATH','BASEURL','CLASSESPATH','MODULOPATH','CSSPATH','JSPATH','BDHOST','BDUSER','BDPASS','BDNAME');
	...
	function loadModulo($modulo=NULL, $tela=NULL){
		if($modulo == NULL || $tela == NULL):
			...
			if(file_exists(BASEPATH.MODULOPATH."$modulo.php")):
				include_once(BASEPATH.MODULOPATH."$modulo.php");
			else:
